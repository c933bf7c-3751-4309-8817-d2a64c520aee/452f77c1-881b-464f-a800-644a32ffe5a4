...
// Move to Parkir Pages
document.addEventListener("DOMContentLoaded", () => {
  const parkirDiv = document.getElementById('parkir-div');

  if (parkirDiv) {
    parkirDiv.addEventListener('click', () => {
      window.location.href = '/parkir-page'; // Replace '/parkir-page' with the actual path you want to navigate to
    });
  }
});
